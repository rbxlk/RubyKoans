...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Allows variables to be injected and then operated on with each item in the array.
  end
  ...
  #   # code to read 'file'
  # I assume because storing the whole file in a variable could prove problematic for
  # speed of the operation. Where |file| is a temporary variable for what we want to do.
